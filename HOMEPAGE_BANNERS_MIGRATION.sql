-- SparkCart Mall: Homepage Banner / Slider Management
...
select * from (values
  ('🔥 FLASH SALE', 'প্রতিদিনের প্রয়োজনীয় পণ্য, এক জায়গায়', 'বিশেষ অফার, দ্রুত ডেলিভারি ও সহজ COD checkout — SparkCart Mall-এ।', 'অফার দেখুন', '#flashSale', null, 1, true),
  ...
  ('🏪 SELL ON SPARKCART', 'আপনিও Seller হোন', 'আপনার পণ্য SparkCart Mall-এ বিক্রি করার জন্য seller application পাঠান।', 'Become a Seller', '#seller', null, 3, true)
