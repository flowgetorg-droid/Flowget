...
-- FlowGet Product Schema Compatibility
-- Safe/additive for existing databases. No DROP, TRUNCATE or DELETE.
-- The app supports both legacy TEXT and fresh JSONB specifications columns.
-- Run once only if your existing products table is missing any of these columns.
